        ...
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            <div className="">
              ...
              <input type="email" value={email} onChange={(e)=> setEmail(e.target.value)} placeholder="youremail@gmail.com"/>
            </div>
            <div className="">
            ...
            <button type="submit" disabled={loading} className="w-full py-3 bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-md text-sm font-semibold hover:from-blue-700 hover:to-blue-600 disabled:opacity-50 transition-all duration-200 shadow-lg shadow-indigo-500/25 active:scale-[0.98] flex items-center justify-center">
