    ...
    <div className='fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm' onClick={onClose}>
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in" onClick={(e)=>e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="">
            <label className="flex items-center gap-2 text-sm font-medium text-salte-700 mb-2">
          ...
          <div className="">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="">
                ...
                <input type="date" name="startDate" className="" min={minDate} required/>
              </div>
              <div className="">
                <span className='block text-xs text-slate-400 mb-1'>To</span>
                <input type="date" name="endDate" className="" min={minDate} required/>
              </div>
            </div>
          </div>
          <div className="">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <button onClick={onClose} type='submit' className='btn-secondary flex-1 flex items-center justify-center gap-2' disabled={loading}>
