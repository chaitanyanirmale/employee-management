      ...
      <div className="card max-w-lg w-full p-6 animate-slide-up">
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button onClick={()=> setOpen(false)} type='button' className='btn-secondary'>Cancel</button>
            <button type='submit' className='btn-primary flex items-center' disabled={loading}>{loading && <Loader2 className='w-4 h-4 mr-2 animate-spin'/>} Generate</button>
          </div>
        </form>
      </div>
    </div>
