...
const LoginLanding = () => {
  const portalOptions = [
    ...
    },
    {
      ...
      description: "View your profile, track attendence, request time off, and success payslips.",
      icon: UserIcon
    }
  ]
  return (
    <div className="min-h-screen flex flex-col md:flex-row">
      <LoginLeftSide />
      <div className="w-full md:w-1/2 flex flex-col items-center justify-center p-6 sm:p-12 lg:p-16 relative overflow-y-auto min-h-screen bg-yellow-300">
        <div className="w-full max-w-md animate-fade-in relative z-10">
          ...
          <div className="mt-12 text-center md:text-left text-sm text-slate-600">
            <p className="flex"><CopyrightIcon className="h-5"/>{new Date().getFullYear()} ChaitanyaNirmale. All rights reserved</p>
          </div>
        </div>
      </div>
    </div>
