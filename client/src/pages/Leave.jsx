        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-5 mb-8">
          {leaveStats.map((s)=>(
            <div key={s.label} className="card card-hover p-5 sm:p-6 flex items-center gap-4 relative overflow-hidden group">
              <div className="absolute left-0 top-0 bottom-0 w-1 rounded-r-full bg-yellow-300/70 group-hover:bg-yellow-500/70"/>
              <div className="p-3 bg-yellow-200 rounded-lg group-hover:bg-yellow-100 transition-colors duration-200">
